...
**The Problem**
Most teams shipping LLM-powered features change prompts the same way they'd edit a config value:push it, watch for complaints. There is no equivalent of a unit of test suite for "does this prompt still produce correct outputs?" This project builds that missing piece - CI for prompt/model behavior,not just code correctness.
...
src/
  ...
  ...                (eval engine, reporting — added in later phases)
...
cp  .env   # then fill in  ANTHROPIC_API_KEY
